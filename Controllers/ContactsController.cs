...
namespace PhoneBookApp1.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public ActionResult Index(int? id)
        {
            ...
            var contacts = db.Contacts.Where(c => c.Person.PersonId == PersonId);
            //var contacts = from r in db.Contacts where TempData[User.Identity.GetUserId()].ToString() == r.Person.PersonId.ToString() select r;
        ...
        {
            ViewBag.PersonId = new SelectList(db.People, "PersonId", "FirstName", PersonId);
            return View();
        }
